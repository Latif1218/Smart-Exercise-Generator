...
def _build_system_prompt() -> str:
    ...
    """
    return """You are an expert educational content creator specializing in creating practice exercises 
from textbook content. Your task is to generate high-quality questions based on the provided text.

You must ALWAYS respond with valid JSON only. No explanation, no markdown, just pure JSON.
The JSON structure must be exactly as specified in the user's request."""
